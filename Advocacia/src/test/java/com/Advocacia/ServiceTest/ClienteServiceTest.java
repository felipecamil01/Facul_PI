...
//        clienteAtualizado.setNome("Pedro Atualizado");
...
//        assertEquals(1L, updatedCliente.getId());
//        assertEquals(StatusCliente.ATIVO, updatedCliente.getStatusCliente());
...
//
//        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> clienteService.update(2L, cliente));
//
...
//        when(clienteRepository.findById(anyLong())).thenReturn(Optional.empty());
//
//        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> clienteService.delete(1L));
//
//        assertEquals("Cliente não encontrado", exception.getMessage());
...
//
//        when(clienteRepository.findAllAtivos(StatusCliente.ATIVO)).thenReturn(List.of(cliente1, cliente2));
//
//        List<Cliente> clientesAtivos = clienteService.findAll();
//
//        assertNotNull(clientesAtivos);
//        assertEquals(2, clientesAtivos.size());
//        assertTrue(clientesAtivos.stream().allMatch(c -> c.getStatusCliente() == StatusCliente.ATIVO));
...
//        cliente1.setNome("João Silva");
//
//        when(clienteRepository.findByNomeContainingIgnoreCase("joao")).thenReturn(List.of(cliente1));
//
