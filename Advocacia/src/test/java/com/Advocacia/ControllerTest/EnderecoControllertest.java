...
class EnderecoControllerTest {
     ...
     * when(enderecoService.update(eq(id),
     * any(Endereco.class))).thenReturn(enderecoAtualizado);
     * 
     * ResponseEntity<Endereco> response = enderecoController.update(id,
     * enderecoAtualizado);
     * 
     ...
     * Long id = 1L;
     * Endereco enderecoAtualizado = new Endereco();
     * when(enderecoService.update(eq(id), any(Endereco.class))).thenThrow(new
