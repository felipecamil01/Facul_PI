...
class ProcessoControllerTest {
     ...
     * 
     * when(processoService.update(eq(id),
     * any(Processo.class))).thenReturn(processoAtualizado);
     * 
     * ResponseEntity<Processo> response = processoController.update(id,
     * processoAtualizado);
     * 
     ...
     * processoAtualizado.setTipoCliente("Cliente B");
     * 
     * doThrow(new EntityNotFoundException()).when(processoService).update(eq(id),
     * any(Processo.class));
     * 
     * ResponseEntity<Processo> response = processoController.update(id,
     * processoAtualizado);
     ...
     * 
     * when(processoService.findByNumeroProcesso(numero)).thenReturn(Arrays.asList(
     * processo));
     * 
     * ResponseEntity<List<Processo>> response =
     * processoController.findByNumeroProcesso(numero);
     * 
     * assertEquals(HttpStatus.OK, response.getStatusCode());
