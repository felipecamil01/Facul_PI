...
class ContatoServiceTest {
     ...
     * @Test
     * void testSave() {
     * Mockito.when(clienteRepository.findById(anyLong())).thenReturn(Optional.of(
     * cliente));
     ...
     * @Test
     * void testUpdate() {
     * Mockito.when(contatoRepository.findById(anyLong())).thenReturn(Optional.of(
     * contato));
     * Mockito.when(clienteRepository.findById(anyLong())).thenReturn(Optional.of(
     * cliente));
     * Mockito.when(contatoRepository.save(any(Contato.class))).thenReturn(contato);
     ...
     * 
     * EntityNotFoundException exception =
     * assertThrows(EntityNotFoundException.class, () -> contatoService.update(1L,
     * contatoDto));
     * 
     ...
     * 
     * EntityNotFoundException exception =
     * assertThrows(EntityNotFoundException.class, () -> contatoService.delete(1L));
     * 
     ...
     * List<Contato> contatos = Collections.singletonList(contato);
     * Mockito.when(contatoRepository.findByClienteId(anyLong())).thenReturn(
     * contatos);
     * 
