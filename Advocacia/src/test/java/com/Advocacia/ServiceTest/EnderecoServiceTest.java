...
class EnderecoServiceTest {
     ...
     * Mockito.when(enderecoRepository.save(any(Endereco.class))).thenReturn(
     * endereco);
     * 
     ...
     * Mockito.when(enderecoRepository.findById(anyLong())).thenReturn(Optional.of(
     * endereco));
     * Mockito.when(enderecoRepository.save(any(Endereco.class))).thenReturn(
     * endereco);
     * 
     ...
     * Mockito.when(enderecoRepository.findById(anyLong())).thenReturn(Optional.
     * empty());
     * 
