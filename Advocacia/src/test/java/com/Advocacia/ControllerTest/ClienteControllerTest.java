...
class ClienteControllerTest {
     ...
     * 
     * when(clienteService.update(eq(id),
     * any(Cliente.class))).thenReturn(clienteAtualizado);
     * 
     * ResponseEntity<Cliente> response = clienteController.update(id,
     * clienteAtualizado);
     * 
     ...
     * Cliente clienteAtualizado = new Cliente();
     * 
     * when(clienteService.update(eq(id), any(Cliente.class))).thenThrow(new
