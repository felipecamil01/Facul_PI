...
public class ClienteServiceTest {
     ...
     * assertThrows(EntityNotFoundException.class, () -> clienteService.update(2L,
     * cliente));
     * 
     ...
     * 
     * when(clienteRepository.findAllAtivos(StatusCliente.ATIVO)).thenReturn(List.of
     * (cliente1, cliente2));
     * 
     ...
     * assertTrue(clientesAtivos.stream().allMatch(c -> c.getStatusCliente() ==
     * StatusCliente.ATIVO));
     ...
     * cliente1.setNome("João Silva");
     * 
     * when(clienteRepository.findByNomeContainingIgnoreCase("joao")).thenReturn(
     * List.of(cliente1));
     * 
