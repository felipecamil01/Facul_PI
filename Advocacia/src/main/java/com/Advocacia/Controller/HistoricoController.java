...
import org.springframework.beans.factory.annotation.Autowired; // Importe se não estiver
...
@RequestMapping("/api/historico") // <-- ESSENCIAL: Define a URL base para todos os métodos
public class HistoricoController {

  private final HistoricoService historicoService;

  @Autowired // <-- Boa prática usar injeção de dependência via construtor
