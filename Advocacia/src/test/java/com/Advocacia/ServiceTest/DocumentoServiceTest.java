...
class DocumentoServiceTest {
     ...
     * Mockito.when(documentoRepository.save(any(Documento.class))).thenReturn(
     * documento);
     * 
     ...
     * Mockito.when(documentoRepository.findById(anyLong())).thenReturn(Optional.of(
     * documento));
     * Mockito.when(documentoRepository.save(any(Documento.class))).thenReturn(
     * documento);
     * 
     ...
     * Mockito.when(documentoRepository.findById(anyLong())).thenReturn(Optional.
     * empty());
     * 
